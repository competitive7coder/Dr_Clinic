      ...
      <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4 reveal" ref={revealRef} style={{ transitionDelay: '300ms' }}>
          ...
          <a
            ...
            className="group px-8 py-5 bg-white border border-slate-200 rounded-[1.5rem] font-black text-[10px] uppercase tracking-[0.3em] text-slate-950 hover:border-blue-600 hover:text-blue-600 transition-all text-center flex items-center justify-center gap-3 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
          >
            <svg
              ...
              aria-hidden="true"
            >
              <path d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.01-.24c1.12.37 2.33.57 3.58.57a1 1 0 011 1v3.5a1 1 0 01-1 1C10.07 22 2 13.93 2 3.5a1 1 0 011-1H6.5a1 1 0 011 1c0 1.25.2 2.46.57 3.58a1 1 0 01-.24 1.01l-2.2 2.2z" />
            </svg>
        ...
        <div className="relative w-full max-w-[420px] perspective-1000">
          ...
          <div className="relative z-10 aspect-[4/5] rounded-[2.5rem] overflow-hidden bg-slate-100 shadow-[0_40px_80px_-20px_rgba(2,6,23,0.15)] border-[8px] border-white ring-1 ring-slate-200 group transition-all duration-1000 transform hover:rotate-y-2 hover:scale-[1.02]">
            ...
            <div className="absolute bottom-8 left-8 text-white">
              <div className="inline-block px-2.5 py-1 bg-blue-600 text-white text-[8px] font-black uppercase tracking-[0.3em] mb-2 rounded-md shadow-lg">SENIOR DOCTOR</div>
          ...
          <div className="absolute bottom-16 -right-8 z-20 bg-slate-950 text-white p-6 rounded-[2rem] shadow-[0_30px_60px_-15px_rgba(2,6,23,0.5)] border border-white/10 w-[220px] animate-float-slow hover:bg-blue-900 transition-colors duration-700 cursor-pointer">
